...
# python -m mshyper.train --config mshyper/configs/rd_lambda.py  --alsologtostderr --config.train_eval_config.num_steps=2000000 --config.model_config.rd_lambda=0.01
